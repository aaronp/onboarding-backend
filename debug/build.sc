...
// mill _.publishLocal
// mill _.test.test
object kind-docstore extends SbtModule with ScalafmtModule with PublishModule {
  def scalaVersion = "3.4.1"

  def pomSettings = PomSettings(
    description = "kind-docstore",
    organization = "kind",
    url = "https://github.com/<username>/kind-docstore",
    licenses = Seq(License.MIT),
    versionControl = VersionControl.github("<username>", "kind-docstore"),
    developers = Seq(
